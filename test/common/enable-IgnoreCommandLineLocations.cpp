// RUN: %python %S/../check_clang_tidy.py %s misra-cpp2008-17-0-1 %t -config='{CheckOptions: [{key: misra-cpp2008-17-0-1.IgnoreCommandLineLocations, value: 1}]}' -- -D__MY_DANGEROUS_MACRO
